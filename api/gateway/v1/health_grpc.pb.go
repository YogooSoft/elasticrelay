...
const (
	HealthService_Check_FullMethodName = "/gateway.v1.HealthService/Check"
	HealthService_Watch_FullMethodName = "/gateway.v1.HealthService/Watch"
)
...
//
// HealthService provides health checks for the services.
type HealthServiceClient interface {
	// Checks the health of the service.
	Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error)
	// Watches the health of the service.
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.v1.HealthService",
	...
	Metadata: "api/gateway/v1/health.proto",
}
